...
# ADD LINK32 d3dx9.lib d3d9.lib d3dxof.lib dxguid.lib ddraw.lib comctl32.lib winmm.lib /nologo /stack:0x200000,0x200000 /subsystem:windows /machine:I386 /ignore:4078 /ignore:4089
...
# ADD LINK32 d3dx9dt.lib d3d9.lib d3dxof.lib dxguid.lib ddraw.lib comctl32.lib winmm.lib /nologo /stack:0x200000,0x200000 /subsystem:windows /debug /machine:I386 /pdbtype:sept /ignore:4089 /ignore:4078

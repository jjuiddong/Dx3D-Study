...
BEGIN_MESSAGE_MAP( CAppForm, CFormView )
	...
	ON_EN_CHANGE(  IDC_TEX3_NAME,     OnChangeTex )
    ON_EN_CHANGE(  IDC_TEX4_NAME,     OnChangeTex )
    ...
    ON_BN_CLICKED( IDC_SELECTTEX3,    OnSelectTexture3Name )
    ON_BN_CLICKED( IDC_SELECTTEX4,    OnSelectTexture4Name )
    ...
    ON_CBN_SELCHANGE( IDC_TEX0_COLORARG0, OnChangeStageArgs )
    ...
    ON_CBN_SELCHANGE( IDC_TEX0_ALPHAARG0, OnChangeStageArgs )
    ON_CBN_SELCHANGE( IDC_TEX0_RESULT,    OnChangeStageArgs )
    ...
    ON_CBN_SELCHANGE( IDC_TEX1_COLORARG0, OnChangeStageArgs )
    ...
    ON_CBN_SELCHANGE( IDC_TEX1_ALPHAARG0, OnChangeStageArgs )
    ON_CBN_SELCHANGE( IDC_TEX1_RESULT,    OnChangeStageArgs )
    ...
    ON_CBN_SELCHANGE( IDC_TEX2_COLORARG0, OnChangeStageArgs )
    ...
    ON_CBN_SELCHANGE( IDC_TEX2_ALPHAARG0, OnChangeStageArgs )
    ON_CBN_SELCHANGE( IDC_TEX2_RESULT,    OnChangeStageArgs )
    ON_CBN_SELCHANGE( IDC_TEX3_COLORARG1, OnChangeStageArgs )
    ON_CBN_SELCHANGE( IDC_TEX3_COLOROP,   OnChangeStageArgs )
    ON_CBN_SELCHANGE( IDC_TEX3_COLORARG2, OnChangeStageArgs )
    ON_CBN_SELCHANGE( IDC_TEX3_COLORARG0, OnChangeStageArgs )
    ON_CBN_SELCHANGE( IDC_TEX3_ALPHAARG1, OnChangeStageArgs )
    ON_CBN_SELCHANGE( IDC_TEX3_ALPHAOP,   OnChangeStageArgs )
    ON_CBN_SELCHANGE( IDC_TEX3_ALPHAARG2, OnChangeStageArgs )
    ON_CBN_SELCHANGE( IDC_TEX3_ALPHAARG0, OnChangeStageArgs )
    ON_CBN_SELCHANGE( IDC_TEX3_RESULT,    OnChangeStageArgs )
    ON_CBN_SELCHANGE( IDC_TEX4_COLORARG1, OnChangeStageArgs )
    ON_CBN_SELCHANGE( IDC_TEX4_COLOROP,   OnChangeStageArgs )
    ON_CBN_SELCHANGE( IDC_TEX4_COLORARG2, OnChangeStageArgs )
    ON_CBN_SELCHANGE( IDC_TEX4_COLORARG0, OnChangeStageArgs )
    ON_CBN_SELCHANGE( IDC_TEX4_ALPHAARG1, OnChangeStageArgs )
    ON_CBN_SELCHANGE( IDC_TEX4_ALPHAOP,   OnChangeStageArgs )
    ON_CBN_SELCHANGE( IDC_TEX4_ALPHAARG2, OnChangeStageArgs )
    ON_CBN_SELCHANGE( IDC_TEX4_ALPHAARG0, OnChangeStageArgs )
    ON_CBN_SELCHANGE( IDC_TEX4_RESULT,    OnChangeStageArgs )

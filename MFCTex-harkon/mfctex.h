...
private:
    ...
    CComboBox *m_pTex0ColorArg1, *m_pTex0ColorOp, *m_pTex0ColorArg2, *m_pTex0ColorArg0;
    CComboBox *m_pTex0AlphaArg1, *m_pTex0AlphaOp, *m_pTex0AlphaArg2, *m_pTex0AlphaArg0;
    CComboBox *m_pTex1ColorArg1, *m_pTex1ColorOp, *m_pTex1ColorArg2, *m_pTex1ColorArg0;
    CComboBox *m_pTex1AlphaArg1, *m_pTex1AlphaOp, *m_pTex1AlphaArg2, *m_pTex1AlphaArg0;
    CComboBox *m_pTex2ColorArg1, *m_pTex2ColorOp, *m_pTex2ColorArg2, *m_pTex2ColorArg0;
    CComboBox *m_pTex2AlphaArg1, *m_pTex2AlphaOp, *m_pTex2AlphaArg2, *m_pTex2AlphaArg0;
	CComboBox *m_pTex3ColorArg1, *m_pTex3ColorOp, *m_pTex3ColorArg2, *m_pTex3ColorArg0;
    CComboBox *m_pTex3AlphaArg1, *m_pTex3AlphaOp, *m_pTex3AlphaArg2, *m_pTex3AlphaArg0;
	CComboBox *m_pTex4ColorArg1, *m_pTex4ColorOp, *m_pTex4ColorArg2, *m_pTex4ColorArg0;
    CComboBox *m_pTex4AlphaArg1, *m_pTex4AlphaOp, *m_pTex4AlphaArg2, *m_pTex4AlphaArg0;


    CComboBox *m_pTex0ResultArg, *m_pTex1ResultArg, *m_pTex2ResultArg, *m_pTex3ResultArg, *m_pTex4ResultArg;

    PDIRECT3DVERTEXBUFFER9 m_pVBWalls;
    PDIRECT3DVERTEXBUFFER9 m_pVBFloorCeiling;
    ...
    VOID    DisableUnusedColorArgs( WORD stage, LONG op );
    VOID    DisableUnusedAlphaArgs( WORD stage, LONG op );
    VOID    DisableUnusedArguments( WORD base, LONG op );
    VOID    UpdateStageColor( WORD stage, LONG op, LONG arg1, LONG arg2, LONG arg0 );
    VOID    UpdateStageAlpha( WORD stage, LONG op, LONG arg1, LONG arg2, LONG arg0 );
    VOID    UpdateStageResult( WORD stage, LONG arg );
    VOID    SetTextureMaps( const TCHAR*, const TCHAR*, const TCHAR*, const TCHAR*, const TCHAR* );
...
public:
	...
	afx_msg VOID OnSelectTexture3Name();
	afx_msg VOID OnSelectTexture4Name();

...
//-----------------------------------------------------------------------------
extern WORD  g_wT0COp,   g_wT1COp,   g_wT2COp,   g_wT3COp,   g_wT4COp;
extern WORD  g_wT0CArg1, g_wT1CArg1, g_wT2CArg1, g_wT3CArg1, g_wT4CArg1;
extern WORD  g_wT0CArg2, g_wT1CArg2, g_wT2CArg2, g_wT3CArg2, g_wT4CArg2;
extern WORD  g_wT0CArg0, g_wT1CArg0, g_wT2CArg0, g_wT3CArg0, g_wT4CArg0;
extern WORD  g_wT0AOp,   g_wT1AOp,   g_wT2AOp,   g_wT3AOp,   g_wT4AOp;
extern WORD  g_wT0AArg1, g_wT1AArg1, g_wT2AArg1, g_wT3AArg1, g_wT4AArg1;
extern WORD  g_wT0AArg2, g_wT1AArg2, g_wT2AArg2, g_wT3AArg2, g_wT4AArg2;
extern WORD  g_wT0AArg0, g_wT1AArg0, g_wT2AArg0, g_wT3AArg0, g_wT4AArg0;
extern WORD  g_wT0RArg,  g_wT1RArg,  g_wT2RArg,  g_wT3RArg,  g_wT4RArg;
...
VOID CAppForm::DisableUnusedColorArgs( WORD stage, LONG op )
{
    ...
    switch( stage )
    {
        ...
        case 3:     wListID = IDC_TEX3_COLOROP; break;
        case 4:     wListID = IDC_TEX4_COLOROP; break;
...
VOID CAppForm::DisableUnusedAlphaArgs( WORD stage, LONG op )
{
    ...
    switch( stage )
    {
		...
		case 3:     wListID = IDC_TEX3_ALPHAOP; break;
        case 4:     wListID = IDC_TEX4_ALPHAOP; break;
...
VOID CAppForm::UpdateUIForDeviceCapabilites()
{
    ...
    m_pTex3ColorOp->EnableWindow( g_dwMaxTextureBlendStages>3 ? TRUE : FALSE );
    m_pTex3AlphaOp->EnableWindow( g_dwMaxTextureBlendStages>3 ? TRUE : FALSE );
    m_pTex3ColorArg1->EnableWindow( g_dwMaxTextureBlendStages>3 ? TRUE : FALSE );
    m_pTex3ColorArg2->EnableWindow( g_dwMaxTextureBlendStages>3 ? TRUE : FALSE );
    m_pTex3ColorArg0->EnableWindow( g_dwMaxTextureBlendStages>3 ? TRUE : FALSE );
    m_pTex3AlphaArg1->EnableWindow( g_dwMaxTextureBlendStages>3 ? TRUE : FALSE );
    m_pTex3AlphaArg2->EnableWindow( g_dwMaxTextureBlendStages>3 ? TRUE : FALSE );
    m_pTex3AlphaArg0->EnableWindow( g_dwMaxTextureBlendStages>3 ? TRUE : FALSE );
    m_pTex3ResultArg->EnableWindow( g_dwMaxTextureBlendStages>3 ? TRUE : FALSE );

    m_pTex4ColorOp->EnableWindow( g_dwMaxTextureBlendStages>4 ? TRUE : FALSE );
    m_pTex4AlphaOp->EnableWindow( g_dwMaxTextureBlendStages>4 ? TRUE : FALSE );
    m_pTex4ColorArg1->EnableWindow( g_dwMaxTextureBlendStages>4 ? TRUE : FALSE );
    m_pTex4ColorArg2->EnableWindow( g_dwMaxTextureBlendStages>4 ? TRUE : FALSE );
    m_pTex4ColorArg0->EnableWindow( g_dwMaxTextureBlendStages>4 ? TRUE : FALSE );
    m_pTex4AlphaArg1->EnableWindow( g_dwMaxTextureBlendStages>4 ? TRUE : FALSE );
    m_pTex4AlphaArg2->EnableWindow( g_dwMaxTextureBlendStages>4 ? TRUE : FALSE );
    m_pTex4AlphaArg0->EnableWindow( g_dwMaxTextureBlendStages>4 ? TRUE : FALSE );
    m_pTex4ResultArg->EnableWindow( g_dwMaxTextureBlendStages>4 ? TRUE : FALSE );
...
{
    CString strName0, strName1, strName2, strName3, strName4;
	...
	((CEdit*)GetDlgItem( IDC_TEX3_NAME ))->GetWindowText( strName3 );
    ((CEdit*)GetDlgItem( IDC_TEX4_NAME ))->GetWindowText( strName4 );

    SetTextureMaps( (LPCTSTR)strName0, (LPCTSTR)strName1, (LPCTSTR)strName2, (LPCTSTR)strName3, (LPCTSTR)strName4 );
}
...
VOID CAppForm::OnSelectTexture3Name()
{
    TCHAR strTextureName[MAX_PATH] = _T("");
    ...
    if( TRUE == GetOpenFileName( &ofn ) )
    {
        GetDlgItem(IDC_TEX3_NAME)->SetWindowText( m_strFileName );
        OnChangeTex();
    }
}

VOID CAppForm::OnSelectTexture4Name()
{
    TCHAR strTextureName[MAX_PATH] = _T("");
    ...
    if( TRUE == GetOpenFileName( &ofn ) )
    {
        GetDlgItem(IDC_TEX4_NAME)->SetWindowText( m_strFileName );
        OnChangeTex();
    }
}
...
VOID CAppForm::UpdateStageColor( WORD stage, LONG op, LONG arg1, LONG arg2, LONG arg0 )
{
	...
	if( stage == 3 )
        wListID = IDC_TEX3_COLOROP;
	if( stage == 4 )
        wListID = IDC_TEX4_COLOROP;
...
VOID CAppForm::UpdateStageAlpha( WORD stage, LONG op, LONG arg1, LONG arg2, LONG arg0 )
{
	...
	if( stage == 3 )
        wListID = IDC_TEX3_ALPHAOP;
    if( stage == 4 )
        wListID = IDC_TEX4_ALPHAOP;
...
VOID CAppForm::UpdateStageResult( WORD stage, LONG arg )
{
	...
	if( stage == 3 )
        wListID = IDC_TEX3_RESULT;
    if( stage == 4 )
        wListID = IDC_TEX4_RESULT;
...
void CAppForm::OnChangePresetEffects()
{
	...
	UpdateStageColor( 3, toDISABLE, ta1TEXTURE, ta2CURRENT, ta0CURRENT );
    UpdateStageAlpha( 3, toDISABLE, ta1TEXTURE, ta2CURRENT, ta0CURRENT );
    UpdateStageColor( 4, toDISABLE, ta1TEXTURE, ta2CURRENT, ta0CURRENT );
    UpdateStageAlpha( 4, toDISABLE, ta1TEXTURE, ta2CURRENT, ta0CURRENT );


    UpdateStageResult( 0, raCURRENT );
    UpdateStageResult( 1, raCURRENT );
    UpdateStageResult( 2, raCURRENT );
	UpdateStageResult( 3, raCURRENT );
    UpdateStageResult( 4, raCURRENT );
...
void CAppForm::OnChangeStageArgs()
{
    ...
    g_wT3COp = aTexOps[ m_pTex3ColorOp->GetCurSel() + 1 ];
    g_wT3AOp = aTexOps[ m_pTex3AlphaOp->GetCurSel() + 1 ];
    g_wT4COp = aTexOps[ m_pTex4ColorOp->GetCurSel() + 1 ];
    g_wT4AOp = aTexOps[ m_pTex4AlphaOp->GetCurSel() + 1 ];
	...
	if( 0 == g_wT3COp ) g_wT3COp = D3DTOP_DISABLE;
    if( 0 == g_wT3AOp ) g_wT3AOp = D3DTOP_DISABLE;
	if( 0 == g_wT4COp ) g_wT4COp = D3DTOP_DISABLE;
    if( 0 == g_wT4AOp ) g_wT4AOp = D3DTOP_DISABLE;
	...
	g_wT3CArg1 = aTexArgs1[ m_pTex3ColorArg1->GetCurSel() + 1 ];
    g_wT3CArg2 = aTexArgs2[ m_pTex3ColorArg2->GetCurSel() + 1 ];
    g_wT3CArg0 = aTexArgs0[ m_pTex3ColorArg0->GetCurSel() + 1 ];
    g_wT3AArg1 = aTexArgs1[ m_pTex3AlphaArg1->GetCurSel() + 1 ];
    g_wT3AArg2 = aTexArgs2[ m_pTex3AlphaArg2->GetCurSel() + 1 ];
    g_wT3AArg0 = aTexArgs0[ m_pTex3AlphaArg0->GetCurSel() + 1 ];

	g_wT4CArg1 = aTexArgs1[ m_pTex4ColorArg1->GetCurSel() + 1 ];
    g_wT4CArg2 = aTexArgs2[ m_pTex4ColorArg2->GetCurSel() + 1 ];
    g_wT4CArg0 = aTexArgs0[ m_pTex4ColorArg0->GetCurSel() + 1 ];
    g_wT4AArg1 = aTexArgs1[ m_pTex4AlphaArg1->GetCurSel() + 1 ];
    g_wT4AArg2 = aTexArgs2[ m_pTex4AlphaArg2->GetCurSel() + 1 ];
    g_wT4AArg0 = aTexArgs0[ m_pTex4AlphaArg0->GetCurSel() + 1 ];
	...
	g_wT3RArg = aResArgs[ m_pTex3ResultArg->GetCurSel() + 1 ];
    g_wT4RArg = aResArgs[ m_pTex4ResultArg->GetCurSel() + 1 ];
	...
	DisableUnusedColorArgs( 3, g_wT3COp );
    DisableUnusedAlphaArgs( 3, g_wT3AOp );
	DisableUnusedColorArgs( 4, g_wT4COp );
    DisableUnusedAlphaArgs( 4, g_wT4AOp );
}

...
#define D3DFVF_WALLVERTEX (D3DFVF_XYZ | D3DFVF_DIFFUSE | D3DFVF_TEX5 )

#define FILL_WALLVERTEX( v, ax, ay, az, acolor, atu1, atv1, atu2, atv2, atu3, atv3, atu4, atv4, atu5, atv5 )  \
{   v.p.x = ax; v.p.y = ay; v.p.z = az; v.dwColor  = acolor; \
    v.tu1 = atu1; v.tv1 = atv1; v.tu2 = atu2; v.tv2 = atv2;\
    v.tu3 = atu3; v.tv3 = atv3;\
	v.tu4 = atu4; v.tv4 = atv4;\
	v.tu5 = atu5; v.tv5 = atv5;\
}
...
//-----------------------------------------------------------------------------
WORD  g_wT0COp,   g_wT1COp,   g_wT2COp,   g_wT3COp,   g_wT4COp;   
WORD  g_wT0CArg1, g_wT1CArg1, g_wT2CArg1, g_wT3CArg1, g_wT4CArg1; 
WORD  g_wT0CArg2, g_wT1CArg2, g_wT2CArg2, g_wT3CArg2, g_wT4CArg2; 
WORD  g_wT0CArg0, g_wT1CArg0, g_wT2CArg0, g_wT3CArg0, g_wT4CArg0; 
WORD  g_wT0AOp,   g_wT1AOp,   g_wT2AOp,   g_wT3AOp,   g_wT4AOp;   
WORD  g_wT0AArg1, g_wT1AArg1, g_wT2AArg1, g_wT3AArg1, g_wT4AArg1; 
WORD  g_wT0AArg2, g_wT1AArg2, g_wT2AArg2, g_wT3AArg2, g_wT4AArg2; 
WORD  g_wT0AArg0, g_wT1AArg0, g_wT2AArg0, g_wT3AArg0, g_wT4AArg0; 
WORD  g_wT0RArg,  g_wT1RArg,  g_wT2RArg,  g_wT3RArg,  g_wT4RArg;  
...
TCHAR g_strTexture3[256];
TCHAR g_strTexture4[256];
...
HRESULT CAppForm::OneTimeSceneInit()
{
	...
	_tcscpy( g_strTexture3, _T("env4.bmp") );
    _tcscpy( g_strTexture4, _T("env5.bmp") );
...
HRESULT CAppForm::InitDeviceObjects()
{
    ...
    FILL_WALLVERTEX( pVertices[ 0], -5.0f,-5.0f, 5.0f, g_dwDiffuseColor, 0.00f, 1.0f, 1.00, 1.0f, 1.00, 1.0f, 1.00, 1.0f, 1.00, 1.0f );              
    FILL_WALLVERTEX( pVertices[ 1], -5.0f, 5.0f, 5.0f, g_dwDiffuseColor, 0.00f, 0.0f, 1.00, 0.0f, 1.00, 0.0f, 1.00, 0.0f, 1.00, 0.0f );              
    FILL_WALLVERTEX( pVertices[ 2],  5.0f,-5.0f, 5.0f, g_dwDiffuseColor, 1.00f, 1.0f, 0.00, 1.0f, 0.00, 1.0f, 0.00, 1.0f, 0.00, 1.0f );              
    FILL_WALLVERTEX( pVertices[ 3],  5.0f, 5.0f, 5.0f, g_dwDiffuseColor, 1.00f, 0.0f, 0.00, 0.0f, 0.00, 0.0f, 0.00, 0.0f, 0.00, 0.0f );              
    FILL_WALLVERTEX( pVertices[ 4],  5.0f,-5.0f,-5.0f, g_dwDiffuseColor, 2.00f, 1.0f, 1.00, 1.0f, 1.00, 1.0f, 1.00, 1.0f, 1.00, 1.0f );              
    FILL_WALLVERTEX( pVertices[ 5],  5.0f, 5.0f,-5.0f, g_dwDiffuseColor, 2.00f, 0.0f, 1.00, 0.0f, 1.00, 0.0f, 1.00, 0.0f, 1.00, 0.0f );              
    FILL_WALLVERTEX( pVertices[ 6], -5.0f,-5.0f,-5.0f, g_dwDiffuseColor, 3.00f, 1.0f, 1.00, 1.0f, 1.00, 1.0f, 1.00, 1.0f, 1.00, 1.0f );              
    FILL_WALLVERTEX( pVertices[ 7], -5.0f, 5.0f,-5.0f, g_dwDiffuseColor, 3.00f, 0.0f, 1.00, 0.0f, 1.00, 0.0f, 1.00, 0.0f, 1.00, 0.0f );              
    FILL_WALLVERTEX( pVertices[ 8], -5.0f,-5.0f, 5.0f, g_dwDiffuseColor, 4.00f, 1.0f, 0.00, 1.0f, 0.00, 1.0f, 0.00, 1.0f, 0.00, 1.0f );              
    FILL_WALLVERTEX( pVertices[ 9], -5.0f, 5.0f, 5.0f, g_dwDiffuseColor, 4.00f, 0.0f, 0.00, 0.0f, 0.00, 0.0f, 0.00, 0.0f, 0.00, 0.0f ); 
    m_pVBWalls->Unlock();
...
VOID CAppForm::SetTextureMaps( const TCHAR* strTexture0, const TCHAR* strTexture1,
                         const TCHAR* strTexture2, const TCHAR* strTexture3 , const TCHAR* strTexture4  )
{
	...
	_tcsncpy( g_strTexture3, strTexture3, sizeof(g_strTexture3) / sizeof(TCHAR) );
    g_strTexture0[sizeof(g_strTexture2) / sizeof(TCHAR) - 1] = _T('\0');

	_tcsncpy( g_strTexture4, strTexture4, sizeof(g_strTexture4) / sizeof(TCHAR) );
    g_strTexture0[sizeof(g_strTexture2) / sizeof(TCHAR) - 1] = _T('\0');

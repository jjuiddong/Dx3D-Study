...
D3DApp::D3DApp(HINSTANCE hInstance, tstring winCaption, D3DDEVTYPE devType, DWORD requestedVP)
{
...
void D3DApp::initMainWindow()
{
	...
	mhMainWnd = CreateWindow(_T("D3DWndClassName"), mMainWndCaption.c_str(), 

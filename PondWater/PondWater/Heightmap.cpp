...
Heightmap::Heightmap(int m, int n,  const tstring& filename, float heightScale, float heightOffset)
{
...
void Heightmap::loadRAW(int m, int n, const tstring& filename, float heightScale, float heightOffset)
{

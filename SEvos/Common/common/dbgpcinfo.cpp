...
BOOL KSystemInfo::GetIPAddress( LPSTR lpBuf, int stringSize )
{
	TCHAR stTemp[255];
...
// Operating System 정보
BOOL KSystemInfo::GetOS(LPSTR lpOS, int stringSize)
{
...
VOID KSystemInfo::GetWorkGroupName(LPTSTR szGroupName, int stringSize, DWORD *pdwSize)
{
...
//				WideCharToMultiByte(CP_ACP, 0, (const unsigned short *)pBuf->wki102_langroup, -1, szTempGroupName, sizeof(szTempGroupName), 0, 0);
				...
				_tcsncpy_s( szGroupName, stringSize, szTempGroupName, nLen );
				szGroupName[nLen] = 0;
				*pdwSize = nLen;
			}
...
void KSystemInfo::GetHddInfo(char *szInfo, int stringSize)
{	
	NAMEGROUP namegroup;
	...
	if( !(namegroup.nItemCnt) ){
		strcpy_s( szInfo, stringSize, "none" );
	}else{
		strcpy_s( szInfo, stringSize, namegroup.szName[0] );
	}
...
void KSystemInfo::GetVgaInfo(char *szInfo, int stringSize)
{
	NAMEGROUP namegroup;
		...
		while( 1 )
		{
			...
			while( 1 )
			{
				...
				if( bVerify ){
					...
					namegroup->nItemCnt++;
					strcpy_s( namegroup->szName[namegroup->nItemCnt-1], sizeof(namegroup->szName), szDesc );
				}
...
void KSystemInfo::GetHddInfo_Win9x( NAMEGROUP *namegroup )
{
	...
	do{
		...
		{
			// INIT PATH BUFF			
			strcpy_s( szRegPath, sizeof(szRegPath), "ESDI" );
			...
			while(1)
			{
				...
				strcpy_s( namegroup->szName[namegroup->nItemCnt], sizeof(namegroup->szName), szDesc );						
				namegroup->nItemCnt++;
...
void KSystemInfo::GetVgaInfo_Win9x( NAMEGROUP *namegroup )
{
	...
	do{
		...
		{
			// INIT PATH BUFF			
			strcpy_s( szRegPath, sizeof(szRegPath), "PCI" );
...
BOOL KSystemInfo::GetComputerName( LPSTR lpBuf, int stringSize )
{	
...
BOOL KSystemInfo::GetCPUInfo( LPSTR lpBuf, int stringSize )
{
...
#define CPU_VAL2 "Identifier"
	...
	strcpy_s( lpBuf, stringSize, szBuf );
...
void KSystemInfo::map_mname(int family, int model, const char *v_name, char *m_name, int nameSize)
{
    ...
    if (!strncmp("AuthenticAMD", v_name, 12)) {
        ...
        case 4: // Am486/AM5x86
            strcpy_s(m_name, nameSize, "AMD Am486");
            break;
        ...
        case 5: // K6
            ...
            case 2:
            case 3:
                strcpy_s (m_name, nameSize, "AMD K5");
                break;
            case 6:
            case 7:
                strcpy_s (m_name, nameSize, "AMD K6");
                break;
            case 8:
                strcpy_s (m_name, nameSize, "AMD K6-2");
                break;
            case 9:
            case 10:
            case 11:
            ...
            case 14:
            case 15:
                strcpy_s(m_name, nameSize, "AMD K6-3");
                break;
            }
            break;
        ...
        case 6: // Athlon
            ...
            strcpy_s(m_name, nameSize, "AMD ATHLON");
            break;
        }
    }
        ...
        case 4:
            ...
            case 0:
            case 1:
                strcpy_s(m_name, nameSize, "INTEL 486DX");
                break;
            case 2:
                strcpy_s (m_name, nameSize, "INTEL 486SX");
                break;
            case 3:
                strcpy_s(m_name, nameSize, "INTEL 486DX2");
                break;
            case 4:
                strcpy_s (m_name, nameSize, "INTEL 486SL");
                break;
            case 5:
                strcpy_s (m_name, nameSize, "INTEL 486SX2");
                break;
            case 7:
                strcpy_s (m_name, nameSize, "INTEL 486DX2E");
                break;
            case 8:
                strcpy_s (m_name, nameSize, "INTEL 486DX4");
                break;
            }
            break;
        ...
        case 5:
            ...
            case 2:
            case 3:
                strcpy_s (m_name, nameSize, "INTEL Pentium");
                break;
            case 4:
                strcpy_s (m_name, nameSize, "INTEL Pentium-MMX");
                break;
            }
            break;
        ...
        case 6:
            switch (model) { // extract model code
            case 1:
                strcpy_s (m_name, nameSize, "INTEL Pentium-Pro");
                break;
            case 3:
            case 5:
                strcpy_s (m_name, nameSize, "INTEL Pentium-II");
                break;  // actual differentiation depends on cache settings
            case 6:
                strcpy_s (m_name, nameSize, "INTEL Celeron");
                break;
            case 7:
            case 8:
            case 10:
                strcpy_s (m_name, nameSize, "INTEL Pentium-III");
                break;  // actual differentiation depends on cache settings
            }
            break;

        case 15 | (0x00 << 4): // family 15, extended family 0x00
			strcpy_s (m_name, nameSize, "INTEL Pentium-IV");
            break;
        }
    }
    else if (!strncmp("CyrixInstead", v_name, 12)) {
        strcpy_s (m_name, nameSize, "Cyrix");
    }
    else if (!strncmp("CentaurHauls", v_name, 12)) {
        strcpy_s (m_name, nameSize, "Centaur");
    }

    if (!m_name[0]) {
        strcpy_s (m_name, nameSize, "Unknown");
    }
}

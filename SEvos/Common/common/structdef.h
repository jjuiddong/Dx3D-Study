...
typedef struct _tagSVtxNormDiff
{
...
typedef struct _tagSVtxTex
{
	enum { FVF = (D3DFVF_XYZ | D3DFVF_TEX1) };
	Vector3 v;
	float tu,tv;
	_tagSVtxTex() {}
	_tagSVtxTex(float x, float y, float z, float tu0, float tv0) :
	v(Vector3(x,y,z)), tu(tu0), tv(tv0) {}
	_tagSVtxTex(const Vector3 &v0, float tu0, float tv0) :
	v(v0), tu(tu0), tv(tv0) {}
} SVtxTex;

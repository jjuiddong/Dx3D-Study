...
protected:
	...
	{
	public:
		CDbgBase( char *szTitle ) { strcpy_s(m_szTitle,sizeof(m_szTitle),szTitle); }
	...
	public:
		...
		int	*m_pVal;
		int m_nModify;
		char* ConvertString() { sprintf_s(m_szDrawBuf, sizeof(m_szDrawBuf), "%s : %d",m_szTitle,*m_pVal); return m_szDrawBuf; }
	...
	public:
		...
		float *m_pVal;
		float m_fModify;
		char* ConvertString() { sprintf_s(m_szDrawBuf, sizeof(m_szDrawBuf), "%s : %f",m_szTitle,*m_pVal); return m_szDrawBuf; }

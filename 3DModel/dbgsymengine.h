/*
 ...
 dbgsymengine class incapsulate Symbol Handler and Debugging Service API
...
#ifndef _dbgsymengine_e4b31bc5_8e01_4cda_b5a4_905dde52ac01
#define _dbgsymengine_e4b31bc5_8e01_4cda_b5a4_905dde52ac01
...
class dbgsymengine
{
 public:
	...
	/*
		...
		%a	: function address (추가:이재정) 2003-09-05
	...
	*/	
	...
	static bool stack_trace(std::ostream&, dbgsymengine&, CONTEXT *,
			unsigned skip = 1, const char * fmt = default_fmt());	
 private:
	static const char * default_fmt() { return "%f(%l) : %m at %a %s\n"; }	
...
#endif //_dbgsymengine_e4b31bc5_8e01_4cda_b5a4_905dde52ac01
